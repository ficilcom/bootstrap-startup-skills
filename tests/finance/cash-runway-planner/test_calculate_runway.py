...
SCRIPT = ROOT / "skills/finance/cash-runway-planner/scripts/calculate_runway.py"
RUNWAY_MODULE = runpy.run_path(str(SCRIPT))
calculate = RUNWAY_MODULE["calculate"]
main = RUNWAY_MODULE["main"]
